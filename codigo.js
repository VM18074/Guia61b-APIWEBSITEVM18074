/*Alumno: Javier Rafael Velásquez Martínez
Carnet: VM18074
#Grupo: 01*/
  ...
  function codigoCat(catstr) {
	...
	function listarProductos(productos) {
	  ...
	  if(orden===0) {orden=-1;precio.innerHTML="Precio"}
	     ...
	     if(orden==1) {ordenarAsc(productos,"price");precio.innerHTML="Precio A";precio.style.color="blue"}
	     else 
	       if(orden==-1) {ordenarDesc(productos,"price");precio.innerHTML="Precio D";precio.style.color="red"}
